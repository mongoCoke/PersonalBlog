var blogDestail = new Vue({
    ...
    created:function(){
        ...
        axios({
            ...
            blogDestail.title = result.title;
            blogDestail.content = result.content;
            blogDestail.ctime = result.ctime;
            blogDestail.tags = result.tags;
            blogDestail.views = result.views;
        }).catch(function(resp){
